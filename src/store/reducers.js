...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_HHGGJHG_LIST:
    case types.API_V1_HHGGJHG_LIST_SUCCEEDED:
    case types.API_V1_HHGGJHG_LIST_FAILED:
    case types.API_V1_HHGGJHG_CREATE:
    case types.API_V1_HHGGJHG_CREATE_SUCCEEDED:
    case types.API_V1_HHGGJHG_CREATE_FAILED:
    case types.API_V1_HHGGJHG_READ:
    case types.API_V1_HHGGJHG_READ_SUCCEEDED:
    case types.API_V1_HHGGJHG_READ_FAILED:
    case types.API_V1_HHGGJHG_UPDATE:
    case types.API_V1_HHGGJHG_UPDATE_SUCCEEDED:
    case types.API_V1_HHGGJHG_UPDATE_FAILED:
    case types.API_V1_HHGGJHG_PARTIAL_UPDATE:
    case types.API_V1_HHGGJHG_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_HHGGJHG_PARTIAL_UPDATE_FAILED:
    case types.API_V1_HHGGJHG_DELETE:
    case types.API_V1_HHGGJHG_DELETE_SUCCEEDED:
    case types.API_V1_HHGGJHG_DELETE_FAILED:
